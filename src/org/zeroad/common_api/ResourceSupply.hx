...
class ResourceSupply
{
	 ...
	 */
	public static function getRessourceArray(baseAi:BaseAI):Array<ResourceSupply>
	{
		return [
			new ResourceSupply(ResourceSupplyTypeValue.FOOD, "", Reflect.field(baseAi.playerData.resourceCounts, ResourceSupplyTypeValue.FOOD)),
			new ResourceSupply(ResourceSupplyTypeValue.WOOD, "", Reflect.field(baseAi.playerData.resourceCounts, ResourceSupplyTypeValue.WOOD)),
			new ResourceSupply(ResourceSupplyTypeValue.STONE, "", Reflect.field(baseAi.playerData.resourceCounts, ResourceSupplyTypeValue.STONE)),
			new ResourceSupply(ResourceSupplyTypeValue.METAL, "", Reflect.field(baseAi.playerData.resourceCounts, ResourceSupplyTypeValue.METAL))
		];
	}
